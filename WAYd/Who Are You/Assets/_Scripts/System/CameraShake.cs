...
public class CameraShake : MonoBehaviour
{
    ...
    public float smallAmplitude, smallFrequency;
    ...
    public IEnumerator smallShakeCam()
    {
        vcam.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_AmplitudeGain = smallAmplitude;
        vcam.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_FrequencyGain = smallFrequency;
        yield return new WaitForSeconds(0.08f);
        vcam.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_AmplitudeGain = 0;
        vcam.GetCinemachineComponent<CinemachineBasicMultiChannelPerlin>().m_FrequencyGain = 0;
    }
